...
export default function Nav4() {
  ...
  return (
    <div className="w-full h-full overflow-hidden relative text-white">
      <div className="w-full h-14 px-10 flex justify-between items-center absolute top-0 left-0 uppercase font-montserrat z-50">
      ...
      <div
        className={`h-screen w-[120vw]  absolute top-0 left-0 bg-purple-900 overflow-hidden z-40 origin-top-left duration-700 ${
